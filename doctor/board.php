        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- Page Heading end-->
                    <?php
                    $res=mysqli_query($con,"SELECT COUNT('`doctor_id`') as COUNT FROM `doctordata`;");
                    $userRow=mysqli_fetch_array($res,MYSQLI_ASSOC);

                    $pat=mysqli_query($con,"SELECT COUNT('`icPatient`') AS COUNT FROM `patient`;");
                    $user=mysqli_fetch_array($pat,MYSQLI_ASSOC);
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo  $userRow['COUNT'] ?></div>
                                        </div>
                                        </div>
                                </div>
                            </div>
